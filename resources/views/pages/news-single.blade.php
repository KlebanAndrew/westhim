                  ...
                  <i class="far fa-folder-open"></i><a href="#"> News</a>
					...
					<div class="author-box d-nlock d-sm-flex">
						<div class="author-img mb-4 mb-md-0">
							<img loading="lazy" src="{{ URL::asset('images/news/avator1.png') }}" alt="author">
						</div>
						...
						<ul class="comments-list">
							<li>
								<div class="comment d-flex">
									<img loading="lazy" class="comment-avatar" alt="author" src="{{ URL::asset('images/news/avator1.png') }}">
								...
								<ul class="comments-reply">
									<li>
										<div class="comment d-flex">
											<img loading="lazy" class="comment-avatar" alt="author" src="{{ URL::asset('images/news/avator2.png') }}">
											<div class="comment-body">
												<div class="meta-data">
								...
								<div class="comment d-flex last">
									<img loading="lazy" class="comment-avatar" alt="author" src="{{ URL::asset('images/news/avator3.png') }}">
									<div class="comment-body">
										<div class="meta-data">
