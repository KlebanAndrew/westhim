					...
					<div class="sidebar sidebar-left">
						<div class="widget">
							...
							<ul class="nav service-menu">
								<li><a href="{{ route(\App\Enums\RouteName::SERVICES_SINGLE) }}">Home Construction</a></li>
								<li class="active"><a href="{{ route(\App\Enums\RouteName::SERVICES_SINGLE) }}">Building Remodels</a></li>
				...
				<div class="col-xl-8 col-lg-8">
					<div class="content-inner-page">
						...
						<div id="page-slider" class="page-slider">
							<div class="item">
								<img loading="lazy" class="img-fluid" src="{{ URL::asset('images/projects/project1.jpg') }}" alt="project-slider-image" />
							</div>

							<div class="item">
								<img loading="lazy" class="img-fluid" src="{{ URL::asset('images/projects/project2.jpg') }}" alt="project-slider-image" />
							</div>
						</div><!-- Page slider end -->
