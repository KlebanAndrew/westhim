<div class="banner-carousel banner-carousel-1 mb-0">
	<div class="banner-carousel-item" style="background-image:url({{ URL::asset('images/slider-main/bg1.jpg') }})">
				...
				<div class="row align-items-center h-100">
					<div class="col-md-12">
						...
						<p data-animation-in="slideInRight">
							<a href="{{ route(\App\Enums\RouteName::SERVICES) }}" class="slider btn btn-primary border">Our Services</a>
						</p>
					</div>
				</div>
			</div>
